 ...
 */
package com.gxhl.jts.utils;

import com.gxhl.jts.common.exception.RestException;
import com.gxhl.jts.common.utils.DateUtils;
import com.gxhl.jts.generator.entity.Column;
import com.gxhl.jts.generator.entity.Table;
...
//        VelocityContext context = new VelocityContext(map);
        ...
        for (String template : templates) {
            ...
            try {
                ...
                throw new RestException("渲染模板失败，表名：" + tableEntity.getTableName(), e);
            }
        }
    }
    ...
    public static Configuration getConfig() {
        try {
            ...
            throw new RestException("获取配置文件失败，", e);
        }
    }
